...
class WatermarkPlus:
    ...
    _watermark_idname = 'watermark_plus'
    ...
    def _watermark_lv2(cls, scene, bpy_data):
        ...
        if not node_tree1:
            ...
            frame_003_1.location = (2076.178955078125, -248.23880004882812)
            ...
            frame_004_1.location = (2527.522216796875, -383.64178466796875)
            ...
            frame_002_1.location = (857.5521850585938, 180.5373077392578)
            ...
            group_output_1.location = (3120.0, -120.0)
            ...
            math_011_1.location = (160.0, -280.0)
            ...
            alpha_over_005_1.location = (340.0, -280.0)
            ...
            set_alpha_1.hide = True
            set_alpha_1.location = (520.0, -280.0)
            set_alpha_1.mute = False
            set_alpha_1.name = 'Set Alpha'
            set_alpha_1.use_custom_color = False
            set_alpha_1.width = 140.0
            ...
            node_tree1.links.new(set_alpha_1.outputs[0], blur_1.inputs[0])
            node_tree1.links.new(alpha_over_005_1.outputs[0], set_alpha_1.inputs[1])
        ...
        watermark_0.inputs[2].default_value = 1.0
